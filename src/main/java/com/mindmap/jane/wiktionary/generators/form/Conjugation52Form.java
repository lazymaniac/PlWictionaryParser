...
public class Conjugation52Form implements ConjugationForm {
    private final ConjugationGenerator koniugacjaGenerator;

    public Conjugation52Form(ConjugationGenerator koniugacjaGenerator) {
    ...
    public void fillConjugation() {
        ...
        koniugacjaGenerator.setTryb_rozkaz_2os_lp("ń");
        koniugacjaGenerator.setTryb_rozkaz_3os_lp("-");
        koniugacjaGenerator.setTryb_rozkaz_1os_lm("ńmy");
        koniugacjaGenerator.setTryb_rozkaz_2os_lm("ńcie");
