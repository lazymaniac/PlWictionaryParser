...
/**
 * The PersonVarTypeEnum enumeration.
 */
public enum PersonVarTypeEnum {
    ...
    public static PersonVarTypeEnum enumOf(String text) {
        if (text != null) {
            for (PersonVarTypeEnum b : PersonVarTypeEnum.values()) {
