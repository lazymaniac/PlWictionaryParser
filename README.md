...
## Configuration
1. Download Wictionary dump from Wictionary website.
2. Unzip and put into project folder. Configure file name and folder in application.yml
3. Run MongoDB, consul, and kafka from docker folder
4. Run PlWordnetParser
5. Call api/update-database
